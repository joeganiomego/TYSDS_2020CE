...
plot!(plt1[1],
xlims = (0.3,a),ylims = (0.2,(b-0.01)),xaxis="[xxn]",yaxis="[N/No]",xticks = 0:0.1:a,yticks = 0:0.1:(b-0.01),grid= false,
title="keju_xxn_NNo_LEBagrarian, SN=0.1",size=(1000,600), show = true)
...
CSV.write("xandN_agrarian01_bw_ODE.csv",sol)
CSV.write("xandN_agrarian01_bw__SDE.csv",SDEsol)
CSV.write("xandN_agrarian01_bw__DDE.csv",DDEsol)
CSV.write("xandN_agrarian01_bw__SDDE.csv",SDDEsol)
...
xaxis="Time[Years]",yaxis="[xxn and N/No]",xticks = 0:(floor(dur/30)):dur,yticks = 0.5:0.1:1.5,grid= false,ylims = (0.5,1.5),
title="keju_xxn_NNo_LEBagrarian, SN=0.1",size=(1000,600), show = true)
