...
title="keju_xxn_NNo_LEBagrarian, SN=0.2",size=(1000,600), show = true)
...
u0 = [0.9, 0.85]; #Initial populations
tspan = (0.0,dur);
...
CSV.write("xandN_agrarian02_bw_ODE.csv",sol)
CSV.write("xandN_agrarian02_bw__SDE.csv",SDEsol)
CSV.write("xandN_agrarian02_bw__DDE.csv",DDEsol)
CSV.write("xandN_agrarian02_bw__SDDE.csv",SDDEsol)
