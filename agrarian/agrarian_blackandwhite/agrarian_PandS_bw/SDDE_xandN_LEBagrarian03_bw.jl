...
Version 03 has bb=0.3405, and gets all of the sudden close to instability.
*/
...
CSV.write("xandN_agrarian03_bw_ODE.csv",sol)
CSV.write("xandN_agrarian03_bw__SDE.csv",SDEsol)
CSV.write("xandN_agrarian03_bw__DDE.csv",DDEsol)
CSV.write("xandN_agrarian03_bw__SDDE.csv",SDDEsol)
