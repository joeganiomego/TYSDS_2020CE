...
plot!(plt1[1],
xlims = (0.6,a),ylims = (0.05,(b-0.01)),xaxis="[P/No]",yaxis="[E/No]",xticks = 0:0.1:a,yticks = 0:0.01:b,grid= false,
title="P and E LEBagrarian",size=(1000,600), show = true)
...
CSV.write("PandE_agrarian01_bw_ODE.csv",sol)
CSV.write("PandE_agrarian01_bw__SDE.csv",SDEsol)
CSV.write("PandE_agrarian01_bw__DDE.csv",DDEsol)
CSV.write("PandE_agrarian01_bw__SDDE.csv",SDDEsol)
...
xaxis="Time[Years]",yaxis="[P/No and E/No]",xticks = 0:(floor(dur/30)):dur,yticks = 0:0.05:a,grid= false,ylims = (0,a),
title="P and E LEBagrarian",size=(1000,600), show = true)
