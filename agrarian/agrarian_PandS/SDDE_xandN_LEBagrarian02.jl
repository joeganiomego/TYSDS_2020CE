#=
/*
02 Version.  Conditions squewed toward degenerated Elite State and over reproduction.
*/
...
# Almost Close to implosion Version Parameters
...
# isoclines color ###############
plt1 = plot(layout=(1,1),show = true,title="keju_xxn_NNo_LEBagrarian, SN=0.2",size=(600,400))
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_1big")
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_1big")
...
u0 = [0.97, 0.90]; #Initial populations
tspan = (0.0,dur);
...
CSV.write("xandN_agrarian02_ODE.csv",sol)
CSV.write("xandN_agrarian02_SDE.csv",SDEsol)
CSV.write("xandN_agrarian02_DDE.csv",DDEsol)
CSV.write("xandN_agrarian02_SDDE.csv",SDDEsol)
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_2big")
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_2big")
...
plt2 = plot(layout=(1,1),title="keju_xxn_NNo_LEBagrarian, SN=0.2",size=(600,400))
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_3big")
...
#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_xandN_LEBagrarian02_bw_3big")
