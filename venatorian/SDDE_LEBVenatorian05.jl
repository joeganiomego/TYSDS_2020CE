...
/*
/*
05 Version. All improvements together. 
Longer N LEB Conditions due to improved KRtox.  3% KRtox increase.
Higher Hunting Conditions.  Khunt*1.03.  
Resource Husbandry Conditions.  Paleo Husbandry Experimental 0.97*hh

Nominal Conditions +20% Stochastic Random on average dRRot and dNNot
...
# isoclines color ###############
plt1 = plot(layout=(1,1),size=(600,400),title="LEBVenatorian,Overgrown")
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_1big")
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_1")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_1big")
...
CSV.write("venatorian05_ODE.csv",sol)
CSV.write("venatorian05_SDE.csv",SDEsol)
CSV.write("venatorian05_DDE.csv",DDEsol)
CSV.write("venatorian05_SDDE.csv",SDDEsol)
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_2big")
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_2")

plot!(plt1[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_2big")
...
plt2 = plot(layout=(1,1),title="LEBVenatorian,Overgrown",size=(600,400))
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_3big")
...
#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_3")

plot!(plt2[1],size=(1000,600),show = true)

#read(stdin, Char)
savefig("SDDE_LEBVenatorian05_bw_3big")
